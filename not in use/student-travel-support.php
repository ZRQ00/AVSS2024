<?php 
$pageTitle='CCTA 2017 Student Travel Support'; //THIS MUST BE SET FOR EACH PAGE
...
<div class="text" style="margin-top:-10px ;margin-bottom: 5%;">
	...
	<h2>Application Procedures</h2>
		...
		<ul class="list">
			<li>Step 1: Select Submit a paper or session proposal for the CCTA 2017</li>
			<li>Step 2: Select First Submissions: Student Travel Form</li>
			<li>Step 3: To complete the application procedure, the Student's Advisor must contact via e-mail Professor Luca Zaccarian, Chair of Student Activities Committee of the IEEE Control Systems Society (<a href="mailto:zaccarian@laas.fr" style="color:red">zaccarian@laas.fr</a>), and provide him with the following information: 
			<ul class="list">
				<li>Certification that the applicant is currently enrolled as a student and is planning to attend and present a paper at the CCTA 2017</li>
				<li>Short message of support of the Student's application (less than 10 lines).</li>
			</ul>
			</li>
