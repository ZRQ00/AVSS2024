<?php 
$pageTitle='AVSS 2024 Student Best Paper Award'; //THIS MUST BE SET FOR EACH PAGE
...
<div class="text" style="margin-top:-10px ;margin-bottom: 5%;">
	...
	<p>
		<h2>Prize</h2>
		 The award recipient receives round trip (economy class) air fare and up to four conference-rate hotel-nights at the AVSS 2024.  All finalists receive complementary student conference registrations for AVSS 2024.
	</p>

	<p>
		<h2>Presentation of Award</h2>
		The winner will be announced by the CSS President at AVSS 2024 during the CSS Awards Ceremony on Tuesday, August 29, 5:30 PM.  Each finalist will receive a certificate and the winner receives a plaque.  For more information, <a style="color:red" href="http://ieeecss.org/awards/conference-control-technology-and-applications-best-student-paper-award">click here</a> or contact the CSS Chair of the CCTA Best Student-Paper Award committee, Alessandro Beghi (contact information is available on the provided link).
	</p>
