<?php 
$pageTitle='Submission'; //THIS MUST BE SET FOR EACH PAGE
$stylesheet='css/authors.css';
require 'header-left-bar.php'; //THIS MUST BE INCLUDED FOR EACH PAGE
?>
<div class="text">
<h1>Paper submission instructions and guidelines</h1>
<br>
We invite submissions of up to six pages, including references. The maximum size of the abstract is 1000 characters. Any submission must be in PDF format (maximum 10MB); submissions in other formats will be rejected.
...
<ul>
    <li><a style="color:red" href=/resources/avss_latex_template.zip>Latex Template</a></li>
    <li><a style="color:red" href=/resources/avss_word_template.zip>Word Template</a></li>
</ul>
<br>
...
<br><br>
A complete paper must be submitted using one of the above templates, formatted for double-blind review, at the Microsoft Conference Management Toolkit (CMT) site:

<br><br>
Make sure that your browser has cookies and Javascript enabled. Please add <a style="color:red" href="mailto:cmt@microsoft.com">cmt@microsoft.com</a> to your list of safe senders to prevent email announcements from being blocked. If your submission has co-authors, please make sure that you enter their email adresses that correspond exactly to their account names (assuming they have created accounts). They will ensure that your co-authors can also see your submission when they log in. Authorship cannot be changed during the review process.

<br><br>
<h1>Double-Blind Peer Review</h1>
<br>
AVSS 2024 uses a double-blind peer review procedure, i.e. the identity of authors is hidden from reviewers and the identity of reviewers is hidden from authors. In order to identify a paper, one of the authors must first register as a user on the CMT submission website and enter the paper title and abstract. This will result in the allocation of a Paper ID that must be used instead of author names in the preparation of the submission for review. Please be sure to read both the formatting instructions in the templates and policies (below) before submission. The paper must be registered and submitted through CMT by the deadline specified in the Important Dates page of the AVSS 2024 website.
<br><br>
...
<br><br>
<h1>Dual/Double Submission</h1>
<br>
By submitting a manuscript to AVSS, the authors guarantee that it has not been previously published or accepted for publication in substantially similar form in an archival peer-reviewed forum. Furthermore, no paper which contains significant overlap with the contributions of this paper is either under review at the moment of submission or will be submitted during the AVSS 2024 review period to any of the following: another conference, a workshop, or a journal. Note that a Technical Report (departmental, arXiv.org, etc.) that is disseminated without any form of direct peer-review is NOT considered a publication. If there are papers that may appear to violate any of the above conditions, it is the authors’ responsibility to cite these papers (preserving anonymity), argue in the body of your paper why your AVSS 2024 paper is non-trivially different from these concurrent submissions, and include anonymized versions of those papers in the supplemental material.
<br><br>
<h1>Conflict & Responsibilities</h1>
<br>
...
<ul>
    ...
    <li>images and other results in addition to the ones in the paper anonymized</li>
    <li>related submissions to other conferences and journals appendices or technical</li>
    <li>reports containing extended proofs and mathematical derivations that are not essential to the understanding of the submitted paper.</li>
</ul>
<br>
AVSS 2024 encourages authors to submit videos using an MP4 codec such as DivX contained in an AVI or quicktime MOV, compressed with ZIP. Also, please submit a README text file with each video specifying the exact codec used and a URL where the codec can be downloaded.
<br><br>
