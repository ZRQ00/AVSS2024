...
<div class="text">
	<div style="font-weight: bold">
		Registration date TBD. <a style="color:red" href="" target="_blank">Please click here</a>. Note that all attendees must register for the conference, whether author, presenter, or interested participant. Be sure to check out the pre-conference Workshops below.
	</div>
	...
	<p>
		Attendees must register under one of the registration categories listed below.  All registered participants will receive admission to the Welcome and Farewell receptions and one set of the conference proceedings on a USB flash drive. Full registration for Members and Non-Members also includes the conference banquet on TBD.  Registration packets (including printed receipts) for all advance registrations will be available at the conference registration desk.
		<div class="datagrid" style="margin: 20px 0 20px 0;">
		<table style="margin:0 auto;">
			<thead>
				<tr><th>Registration Category</th><th>Advance Registration (by TBD)</th><th>On-Site Registration (after TBD)</th><th>Banquet</th></tr></thead>
			<tbody>
				<tr><td>Member</td><td>TBD USD</td><td>TBD USD</td><td>included</td></tr>
				<tr class="alt"><td>Non-Member</td><td>TBD USD</td><td>TBD USD</td><td>included</td></tr>
				<tr><td>IEEE Life Member/Retiree</td><td>TBD USD</td><td>TBD USD</td><td>not included</td></tr>
				<tr class="alt"><td>Student</td><td>TBD USD</td><td>TBD USD</td><td>not included</td></tr>
			</tbody>
		</table>
		</div>

		<div>
			<span style="font-weight: bold">Member:</span> If you are a member of IEEE, you may register at "Member" rate. This registration category is entitled to upload up to three final papers. Additional papers can be uploaded for TBD USD each. 
		</div>
		<br>
		<div>
			<span style="font-weight: bold">Non-Member:</span> If you are not a member of IEEE you should register at the Non-Member rate. This registration category is entitled to upload up to three final papers. Additional papers can be uploaded for TBD USD each.
		</div>
		<br>
		<div>
			<span style="font-weight: bold">IEEE Life Members:</span> If your IEEE membership status is that of Life Member, Life Senior Member or Life Fellow, you may register at Life Member rate (send an email with your PIN and IEEE number to the registration chair, Professor <a href="" style="color:red">[link to email]</a>, prior to registering). This registration category is entitled to upload up to three final papers. Additional papers can be uploaded for TBD USD each.
		</div>
		<br>
		<div>
			<span style="font-weight: bold">Retiree:</span> If at the time of registration or at the time of initial submission of paper for review you are a member of any of the above organization(s), and had retired or did not hold a full time employment, you may register at Retiree rate. This registration category is entitled to upload ONLY ONE final paper. Additional papers can be uploaded for TBD USD each.
		</div>
		<br>
		<div>
			<span style="font-weight: bold">Student:</span> If at the time of registration or at the time of initial submission of paper for review you were a "full-time student" at a recognized institution, you may register at student rate. You may be required to provide evidence of full-time student status. This registration category is entitled to upload ONLY ONE final paper. Additional papers can be uploaded for TBD USD each.
		</div>
	...
	<p class="bd">
		<ul>
			<li>Cost per paper for extra paper upload: TBD USD</li>
			<li>Excess Page Charges: TBD USD/page (maximum of two beyond six-page limit)</li>
			<li>Additional Proceedings (USB): TBD USD/each</li>
			<li>Additional Evening Banquet Tickets: TBD USD/each</li>
		</ul>
	</p>
	...
	<p class="bd">
		...
		<ul>
			<li>All requests must be sent to the registration chair, Professor <a href="" style="color:red">[link to email]</a></li>
			<li>Requests received by the advance registration deadline of TBD, will be fully honored and all registration charges will be refunded.</li>
			<li>Requests received between TBD and TBD will receive a 50% refund.</li>
			<li>No refunds will be given for requests received after TBD.</li>
		</ul>
	</p>

	<h1>Workshop Registration</h1>
	<div>Three preconference workshops will be offered at AVSS 2024 on TBD. See the <a href="workshops.php" style="color: red">workshops page</a> for more information. Workshop attendance requires a separate registration payment, as noted below. All prices are in U.S. dollars. 
	...
	<table style="margin:0 auto">
		<thead>
			<tr>
				<th colspan="1"></th>
				<th colspan="2">By TBD</th>
				<th colspan="2">After TBD</th>
			</tr>
		</thead>
		<tbody>
