	...
	<div class="flex-column main-container">
		<div id="header" class="flex-auto">
			...
			<div id="header-title-container">
				<div class="header-title bold flux-auto" style=""><img src="images/ieee-logo.png" style="font-family:Archivo Black;"></img><div style="vertical-align: middle;display: inline-block;">AVSS 2024</div></div>
				<div class="header-title bold" style="font-size: x-large;">20th edition of the IEEE International Conference on Advanced Video and Signal-Based Surveillancs</div>
				<div class="header-title bold" style="font-size: large;">July 15-16, 2023</div>
				<div class="header-title bold" style="font-size: medium;">Niagara Falls Marriott on the Falls <br> Niagara Fall, Canad</div>
			</div>
		...
		<div id="content-container" class="flex flex-auto flex-space-between">
			<div id=left-bar-container class="flex flex-auto col-2">
				<ul class="left-bar list-reset">
					<li name="back" class="bold" style="font-size: x-large">IEEE AVSS2024<a href="#" class="slide-back"><i class="fa fa-lg fa-arrow-circle-left" aria-hidden="true"></i></a></li>
			...
			<div id="center-content" class="flex flex-auto flex-column col-7">
				...
				<div class="main-content flex-auto">
					...
					<div class="text">
						...
						<br><br>
						 AVSS 2024 will be organized by the team from University at Buffalo, State University of New York at the Niagara Falls at August 2024. AVSS 2024 will be collocating with the IEEE International Conference on Multimedia and Expo (ICME) which will be held back-to-back at the Canadian side of the Niagara Falls.
					</div>
			...
			<div id="right-bar" class="flex flex-column col-2" style="background: whitesmoke">
				...
				<!-- Paper submissions site css.paperplaza.net opens	 	December 15, 2023
	Deadline for submission of Invited Session proposals	 	March 1, 2024
 	Deadline for submission of contributed and invited papers	 March 1, 2024
 	Notification of acceptance/rejection (upload and register)	 June 1, 2024
 	Deadline for final submission of all papers	 		July 1, 2024 -->
	 			<div id="content" class="flex-auto">
	 				<ul class="list-reset">
						<li>
							<div class="title">Paper Submission Opens</div>
							<div class="date"><i class="fa fa-lg fa-calendar" aria-hidden="true"></i> December 15, 2023</div>
						</li>
						<li>
							<div class="title">Invited Session Proposals Due</div>
							<div class="date"><i class="fa fa-lg fa-calendar" aria-hidden="true"></i> March 1, 2024</div>
						</li>
						<li>
						...
						<li>
							...
							<div class="date"><i class="fa fa-lg fa-calendar" aria-hidden="true"></i> June 1, 2024</div>
						</li>
						<li>
							<div class="title">Final Submissions Due</div>
							<div class="date"><i class="fa fa-lg fa-calendar" aria-hidden="true"></i> July 1, 2024</div>
						</li>
					</ul>
				</div>
